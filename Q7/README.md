...
Note: This project uses python to construct **COST2100-like clustered multipath channel generator** to enable the script to work under python + tensorflow environment.
...
![image]([results/compare_dim128.png](https://github.com/terrychen0803/AI-wireless-midterm/blob/main/Q7/result/compare_dim128.png))
